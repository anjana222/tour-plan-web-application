...
import "../styles/anjana/DesResForm.css";
        ...
        <div className="desrestcktcont">
          <Tilt options={options}>
            <div className="desrestckt">
              ...
              <img
                src={
                  "https://westtorontoservicesforseniors.files.wordpress.com/2014/04/cool-white-background-free-download-desktop-white-background-hd.jpg"
                }
                alt="destination"
              />
            </div>
